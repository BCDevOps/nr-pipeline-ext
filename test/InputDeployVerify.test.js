...
const verify = require("../lib/InputDeployerVerify")
...
describe("Jira", function() {
 ...
 /* describe("verify-before-deployment", function() {
   this.timeout(50000);
   context("On passing RFC/RFD and branch information", function() {
      it.only("verifies if all the issues are approved or in desired state before deployment", function() {
