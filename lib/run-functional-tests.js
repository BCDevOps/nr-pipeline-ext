...
(async function () {
  ...
  childProcess(npmw, ['ci'], {cwd: testFolderDir, env: uitestConfig.env, uid: 1001})
    .then(() => childProcess(npmw, ['run', 'headless-chrome-tests'], {cwd: testFolderDir, env: uitestConfig.env, uid: 1001}))
    .then((result) => {
