...
module.exports = class {
    ...
    static ALL_STATUS = [
        STATUS_CLOSED,
        STATUS_IN_EVAL_FOR_INT,
        STATUS_IN_REVIEW_FOR_INT,
        STATUS_AUTHORIZED_FOR_INT,
        STATUS_IN_EVAL_FOR_TEST,
        STATUS_IN_REVIEW_FOR_TEST,
        STATUS_AUTHORIZED_FOR_TEST,
        STATUS_IN_REVIEW_FOR_PROD,
        STATUS_AUTHORIZED_FOR_PROD,
        STATUS_IN_EVAL_FOR_PROD,
        STATUS_OPEN_FOR_TEST,
        STATUS_OPEN_FOR_PROD,
        STATUS_OPEN_FOR_INT,
    ]
