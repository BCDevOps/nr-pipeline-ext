...
module.exports = class {
  ...
  async build() {
    ...
    if(changeTarget && changeTarget.toLowerCase() == 'master') {
      ...
      await this._gitTargetSyncVerify(gitUrl, changeBranch, changeTarget, username, password);
    }
   ...
   */
  async _gitTargetSyncVerify(gitUrl, changeBranch, changeTarget, username, password) {
    const git = new Git();
