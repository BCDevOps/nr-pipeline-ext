...
module.exports = class {
  ...
  async build(){
    ...
    let changeTarget='';
    if(settings.options.git.change){
      changeTarget = settings.options.git.change.target
    ...
    return gitObj.verify(changeBranch,changeTarget,username,password,gitUrl).then(result=>{
      if(result=='True'){
