...
module.exports = class {
  ...
  async clean() {
    ...
    const target_phase = this.getTargetPhases(env);

    for(const t of target_phase) {
      ...
      let deploymentConfigs = oc.get('dc', {selector:`app=${phase.instance},env-id=${phase.changeId},env-name=${t},!shared,github-repo=${oc.git.repository},github-owner=${oc.git.owner}`, namespace:phase.namespace});
