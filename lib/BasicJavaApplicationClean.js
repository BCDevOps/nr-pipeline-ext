...
module.exports = class {
  ...
  async clean () {
    ...
    for (const t of targetPhase) {
      ...
      const buildConfigs = oc.get('bc', { selector: `app=${phase.instance},env-id=${phase.changeId},!shared,github-repo=${oc.git.repository},github-owner=${oc.git.owner}`, namespace: phase.namespace })
      if (buildConfigs) {
      ...
      const deploymentConfigs = oc.get('dc', { selector: `app=${phase.instance},env-id=${phase.changeId},env-name=${t},!shared,github-repo=${oc.git.repository},github-owner=${oc.git.owner}`, namespace: phase.namespace })
